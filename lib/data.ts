...
export const COCKTAILS: Cocktail[] = [
  {
    ...
    story: "1919 年佛罗伦萨，Camillo Negroni 伯爵走进咖啡馆，嫌美式鸡尾酒太温吞，要求调酒师把苏打水换成金酒。三种材料等量对冲，苦甜互不相让——伯爵大概没想到，这场「调烈一点」的任性，定义了整个鸡尾酒世界一百年的审美。",
    lore: "金酒是执念，味美思是妥协，金巴利是放不下的苦涩——势均力敌，才叫爱情。",
  },
  {
    ...
    video: "https://www.bilibili.com/",
    story: "流传最广的版本里，1940 年代的墨西哥，一位调酒师在打猎时误杀了挚爱的女友 Margarita。他愧疚终生，用她的名字调制了这杯酒：酒液代表心里的痛苦，柠檬汁是喉头的酸楚，杯沿的细盐，是流不尽的眼泪。故事的真相已不可考，但每一杯咸酸交织的玛格丽特，都在替某个失恋的人喝下这口遗憾。",
    lore: "酒液是痛苦，柠檬是酸楚，盐是眼泪——致那份逝去的爱情。",
  },
  {
    ...
    video: "https://www.bilibili.com/",
    story: "莫吉托起源于古巴哈瓦那，据说它的远祖是 16 世纪水手们用来治疗坏血病的草药酒。真正让它封神的，是海明威——他在哈瓦那住了二十年，每天都要去 La Bodeguita 喝上一杯，还留下了那句著名的涂鸦：「我的莫吉托在 La Bodeguita」。从此这杯薄荷青柠的清凉长饮，成了古巴的灵魂名片。",
    lore: "薄荷是夏天，青柠是清醒，朗姆酒是成年人藏在杯底的自由。",
  },
  {
    ...
    video: "https://www.bilibili.com/",
    story: "1880 年代的肯塔基赛马俱乐部，挑剔的绅士们嫌新式鸡尾酒花哨，要求调酒师「用老办法调一杯」——威士忌、糖、苦精，仅此而已。Old Fashioned 由此得名，也从此定义了鸡尾酒最原始的骨架：简单到极致，讲究到极致。",
  ...
  },
  {
    ...
    video: "https://www.bilibili.com/",
    story: "1972 年《教父》上映，马龙·白兰度用沙哑的嗓音说出「我会给他一个无法拒绝的提议」。这杯以苏格兰威士忌为底、杏仁力娇酒调和的酒，恰如教父本人：烈度是力量，甜香是温情，肉桂熏杯升起的那缕烟，是他指尖雪茄的余韵。一杯下肚，你便成了他的家人。",
    lore: "威士忌的烈不容拒绝，杏仁的甜让你甘愿沉沦。",
  },
  {
    ...
    video: "https://www.bilibili.com/",
    story: "大都会兴起于 1980 年代的纽约，真正让它成为都市文化符号的，是《欲望都市》里 Carrie 失恋后点的那一杯。伏特加是都市人的清醒，蔓越莓汁是心口那抹绯红，青柠是尖锐的刺痛——喝完这杯，明天照常上班。",
  ...
  },
  {
    ...
    video: "https://www.bilibili.com/",
    story: "19 世纪的水手远航时带着柠檬和烈酒——柠檬防坏血病，烈酒壮胆。把两者摇在一起加糖，就是最早的酸酒，威士忌酸正是这个家族的教科书。蛋白摇出的绵密泡沫浮在杯顶，像风暴过后的海面，终于平静。",
    lore: "威士忌是风暴，柠檬是清醒，糖是远方灯塔的光。",
  },
  {
    ...
    video: "https://www.bilibili.com/",
    story: "1980 年代的伦敦，一位名模走进酒吧，对调酒师说：「给我一杯能让我清醒，又让我微醺的酒。」于是浓缩咖啡、伏特加、咖啡力娇酒被摇进同一杯。这杯深夜咖啡因与酒精的混合物，从此成为都市夜归人的心照不宣。",
    lore: "浓缩咖啡是生活的真相，伏特加是短暂的逃离。",
  },
  {
    ...
    video: "https://www.bilibili.com/",
    story: "1888 年，新奥尔良的金菲士风靡全城，酒吧门口排起长队，店家不得不雇几十个人专门摇酒。金酒、柠檬、糖浆摇出绵密泡沫，再注入苏打水——一杯会冒泡的柠檬汽水，藏着金酒的骨架。",
    lore: "金酒是热风，柠檬是光斑，气泡是小雀跃。",
  },
  {
    ...
    video: "https://www.bilibili.com/",
    story: "1954 年，波多黎各的调酒师把这杯献给世界：白朗姆、椰奶、菠萝汁摇出的热带甜润，被 1979 年的神曲《Escape》唱进所有人心里——「如果你喜欢椰林飘香，就去海边吧」。它不装深沉，就是坦坦荡荡的快乐。",
    lore: "椰奶是白沙滩，菠萝是赤道线上最甜的太阳。",
  },
  {
    ...
    video: "https://www.bilibili.com/",
    story: "1900 年，古巴独立战争胜利在望，人们把朗姆酒倒进可乐，举杯高呼「Cuba Libre」（自由的古巴）。这杯看似随意的组合，承载的却是压抑了一整个殖民时代的向往——有些自由，是喝出来的。",
    lore: "可乐是沉默，朗姆酒是呐喊，青柠是没掉下来的泪。",
  },
  {
    ...
    video: "https://www.bilibili.com/",
    story: "1915 年，新加坡莱佛士酒店 Long Bar，一位女士想喝一杯「像日落一样温柔的酒」。调酒师 Ngiam Tong Boon 于是调制了这杯粉红色的长饮：金酒打底，樱桃白兰地与石榴糖浆调出晚霞色，菠萝汁续上热带永不落幕的夏天。一百年过去，它仍是「亚洲之最」。",
    lore: "金酒是白天的体面，石榴糖浆是黄昏的暧昧。",
  },
  {
    ...
    video: "https://www.bilibili.com/",
    story: "1970 年代纽约长岛，有人把伏特加、金酒、朗姆、龙舌兰、君度五种烈酒倒进同一杯，再用可乐伪装成冰茶的颜色——看着人畜无害，实则一杯顶五杯。它像一段表面平静的关系，内里早已暗流涌动。",
    lore: "你以为是温柔，其实是烈性。",
  },
];
...
export const CONVENIENCE: Cocktail[] = [
  {
    ...
    story: "养乐多是童年的味道，伏特加是成年的入口。当童年的甜撞上成年的烈，就是这杯便利店里的养乐多特调——零门槛的制作，装着的却是成年人最复杂的心事。",
  ...
  },
  {
    ...
    video: "https://www.douyin.com/",
    story: "冰红茶是学生时代的夏夜，威士忌是工作后的凌晨。把两者倒进同一杯，就是成年人最诚实的自白——拧开瓶盖的那一下，是忙碌生活里难得的喘息。",
  ...
  },
  {
    ...
    video: "https://www.douyin.com/",
    story: "爱尔兰经典「汽车炸弹」的便利店版本：尊美醇威士忌沉进黄油啤酒，一口闷下——像一场勇敢的坠落。黄油啤酒的甜是温柔的假象，威士忌的烈是真实的底色，它教你的不是喝酒，是别犹豫。",
    lore: "有些事，趁热。",
  },
];
