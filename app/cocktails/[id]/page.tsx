    ...
    <div className="max-w-[440px] mx-auto relative z-[1] pb-24 min-h-screen">
      ...
      <div className="page-anim">
        ...
        <div className="px-4.5 pt-3">
          <h1 className="serif text-[26px] leading-tight">{c.name}</h1>
          ...
          <p className="text-[14px] text-[#5a5a56] leading-[1.8]">{c.intro}</p>

          {/* 配料 */}
          <div className="bg-[--panel] border border-[--line] rounded-[16px] p-4 mt-4">
          ...
          {/* 故事 */}
          <div className="bg-[--panel] border border-[--line] rounded-[16px] p-4 mt-4 mb-8">
